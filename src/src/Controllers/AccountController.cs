    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var salaryLedger = new SalaryLedger { Id = user.Id, IdNumber = model.IdNumber, Email = model.Email, FullName = model.FullName };
        ...
        public async Task<IActionResult> RegisterAdmin(Guid org, RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    _context.Employees.Add(employees);
                    _context.CurrentLedger.Add(currentLedger);
                    _context.SalaryLedger.Add(salaryLedger);
                    await _context.SaveChangesAsync();
